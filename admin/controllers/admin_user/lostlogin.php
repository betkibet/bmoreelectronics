								  ...
								  <tbody>
									<tr>
									  <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
										<h4 style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 8px;color: #242b3d;font-size: 18px;line-height: 23px;">Hello, '.$admin_username.'</h4>
										<p style="margin-top: 0px;margin-bottom: 0px;">Please click below link for reset password. If you don\'t send password change request then ignore it.<br><b>Email:</b>'.$email.'<br><b>User Name:</b>'.$admin_username.'</p>
										<p style="margin-top: 0px;margin-bottom: 0px;">Please click <a href="'.ADMIN_URL.'confirm_password_reset.php?t='.$token.'">Here</a> to reset your password.</p>
