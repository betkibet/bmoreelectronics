...
<?php /*?>function get_c_b_d_type(type) {
	if(type == "cat") {
				...
				<div class="row">
					<div class="col-lg-8">
						...
						<div class="m-portlet">
							...
							<!--begin::Form-->
							<form class="m-form" action="controllers/system_page.php" role="form" method="post" onSubmit="return check_form(this);" enctype="multipart/form-data">
								<div class="m-portlet__body">
									<div class="m-form__section m-form__section--first">
										...
										<div class="form-group m-form__group device_showhide" <?php if($c_b_d_type=='device'){echo 'style="display:block;"';}else{echo 'style="display:none;"';}?>>
											...
											<select class="form-control" name="device_id[]" id="device_id[]" onchange="changedevice(this.value);">
												<option value=""> -Select- </option>
										...
										$slug_desc_not_show_array = array('blog');
										...
										<div class="form-group m-form__group">
											...
											if($page_data['image']!="") { ?>
												...
												<a class="btn btn-danger btn-sm" data-dismiss="fileupload" href="controllers/system_page.php?id=<?=$_REQUEST['id']?>&r_img_id=<?=$page_data['id']?>" onclick="return confirm('Are you sure to delete this image?');">Remove</a>
								...
								<div class="m-portlet__foot m-portlet__foot--fit">
									<div class="m-form__actions m-form__actions">
										...
										<a href="system_page.php" class="btn btn-secondary">Back</a>
									</div>
								</div>
							</form>
							<!--end::Form-->
