                      ...
                      <?php
                        ...
                        foreach($inbuild_page_array as $inbuild_page_data) {
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="edit_custom_page.php?id=<?=intval($saved_inbuild_page_data['id'])?>&slug=<?=$inbuild_page_data['slug']?>" class="btn btn-alt btn-default"><i class="icon-pencil"></i></a>
                              <?php
                              if(!empty($saved_inbuild_page_data)) {
                                if($saved_inbuild_page_data['published']==1) {
                                  echo '<a href="controllers/custom_page.php?p_id='.$saved_inbuild_page_data['id'].'&published=0" class="'.($inbuild_page_data['slug']=='home'?' not-active':'').'"><button class="btn btn-alt btn-success">Published</button></a>';
                                } elseif($saved_inbuild_page_data['published']==0) {
                                  echo '<a href="controllers/custom_page.php?p_id='.$saved_inbuild_page_data['id'].'&published=1" class="'.($inbuild_page_data['slug']=='home'?' not-active':'').'"><button class="btn btn-alt btn-danger">Unpublished</button></a>';
                                }
                              }
                              ?>
                            </td>
