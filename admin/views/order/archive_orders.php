			  ...
			  <div class="row m--margin-top-20">
				<div class="col-sm-12">
					<form action="controllers/order/order.php" method="POST">
						...
						<button class="btn btn-sm btn-success m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air bulk_undo" name="bulk_undo">Bulk Undo</button>
					</form>
				</div>
			  </div>
                    ...
                    <table class="table table-bordered table-hover table-checkable dataTable dtr-inline">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td Width="150">
                            <?php /*?><a href="order_offer.php?order_id=<?=$order_data['order_id']?>&order_mode=archive" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air btn-xs">Offer</a><?php */?>
							<?php
							...
							<a href="controllers/order/order.php?u_id=<?=$order_data['order_id']?>&order_mode=archive" class="m-portlet__nav-link btn m-btn m-btn--hover-success m-btn--icon m-btn--icon-only m-btn--pill btn-sm" onclick="return confirm('Are you sure you want to undone this record?');"><i class="la la-undo"></i></a>
                          </td>
                        </tr>
                        <?php }
                        } else {
