	    			...
	    			<div class="m-portlet__body m-portlet__body--no-padding">
	    				<div class="m-invoice-1">
	    					<div class="m-invoice__wrapper">
												...
												if($order_num_of_rows>0) {
													foreach($order_item_list as $order_item_list_data) {
														...
														<tr>
															...
															<td style="text-align:left;"><?=$order_item_list_data['device_title'].' - '.$order_item_data['device_type']?></td>
													...
													<tr>
														<td colspan="3"><strong>Sell Order Total:</strong></td>
													...
													if($promocode_amt>0) { ?>
														...
														<tr>
															<td colspan="3"><strong><?=$discount_amt_label?></strong></td>
	    						...
	    						<?php /*?><div class="m-invoice__footer mt-0">
