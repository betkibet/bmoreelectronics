                    ...
                    <table class="table table-bordered table-hover table-checkable dataTable dtr-inline" <?php /*?>id="m_table_1"<?php */?>>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td Width="150">
                            <?php /*?><a href="order_offer.php?order_id=<?=$order_data['order_id']?>&order_mode=awaiting" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air btn-xs">Offer</a><?php */?>
							<?php
