								...
								<div class="m-portlet__body">
									<div class="m-form__section m-form__section--first">
										...
										<div class="form-group m-form__group">
											...
											<input class="form-control m-input" type="date" id="from_date" name="from_date" placeholder="Enter from date (mm/dd/yyyy)" value="<?=($promocode_data['from_date']!='0000-00-00'?date('Y-m-d',strtotime($promocode_data['from_date'])):'')?>">
										</div>
									</div>
									<div class="form-group m-form__group">
										<label for="input">
										...
										<input class="form-control m-input" type="date" id="to_date" name="to_date" placeholder="Enter to date (mm/dd/yyyy)" value="<?=($promocode_data['to_date']!='0000-00-00'?date('Y-m-d',strtotime($promocode_data['to_date'])):'')?>">
									</div>
