                      ...
                      <tbody>
                        <tr id="tr_bg_checksunday_0">
                          ...
                          <td>
                            ...
                            <div class="gray_selectbox form-group m-form__group">
                              <?php
                               ...
                               ?>
                              <select class="form-control m-input custom-select" id="open_time_zonesunday_0" name="open_time_zone[sunday_0]" <?=$sun_attr?>>
                          ...
                          <td>
                            ...
                            <div class="gray_selectbox form-group m-form__group">
                              <select class="form-control m-input custom-select" id="close_time_zonesunday_0" name="close_time_zone[sunday_0]" <?=$sun_attr?>>
                                <option value=" ">Select</option>
                        ...
                        <tr id="tr_bg_checkmonday_0">
                          ...
                          <td>
                            ...
                            <div class="gray_selectbox form-group m-form__group">
                              ...
                              ?>
                              <select class="form-control m-input custom-select" id="open_time_zonemonday_0" name="open_time_zone[monday_0]" <?=$mon_attr?>>
                              <option value=" ">Select</option>
                          ...
                          <td>
                            ...
                            <div class="gray_selectbox form-group m-form__group">
                              <select class="form-control m-input custom-select" id="close_time_zonemonday_0" name="close_time_zone[monday_0]" <?=$mon_attr?>>
                              <option value=" ">Select</option>
                        ...
                        <tr id="tr_bg_checktuesday_0">
                          ...
                          <td>
                            ...
                            <div class="gray_selectbox form-group m-form__group">
                              ...
                              <select class="form-control m-input custom-select" id="open_time_zonetuesday_0" name="open_time_zone[tuesday_0]" <?=$tues_attr?>>
                                <option value=" ">Select</option>
                          ...
                          <td>
                            <div class="form-group m-form__group"><input type="text" class="<?php if($closed->tuesday=='yes') { echo 'textbox_un_edit';}else{ echo 'textbox'; }?> form-control m-input m-input--square" id="close_time[tuesday_0]" name="close_time[tuesday_0]" value="<?=$close_time->tuesday;?>" <?php if($closed->tuesday=='yes'){echo 'disabled';}?>></div>
                            <div class="gray_selectbox form-group m-form__group">
                              <select class="form-control m-input custom-select" id="close_time_zonetuesday_0" name="close_time_zone[tuesday_0]" <?=$tues_attr?>>
                              <option value=" ">Select</option>
                        ...
                        <tr id="tr_bg_checkwednesday_0">
                          <td>Wednesday</td>
                          <td>
                            <div class="form-group m-form__group"><input type="text" class="<?php if($closed->wednesday=='yes') { echo 'textbox_un_edit';}else{ echo 'textbox'; }?> form-control m-input m-input--square" id="open_time[wednesday_0]" name="open_time[wednesday_0]" value="<?=$open_time->wednesday;?>" <?php if($closed->wednesday=='yes'){ echo 'disabled'; }?>></div>
                            <div class="gray_selectbox form-group m-form__group">
                              <?php
                             ...
                             ?>
                              <select class="form-control m-input custom-select" id="open_time_zonewednesday_0" name="open_time_zone[wednesday_0]" <?=$wed_attr?>>
                                <option value=" ">Select</option>
                          ...
                          <td>
                            <div class="form-group m-form__group"><input type="text" class="<?php if($closed->wednesday=='yes') { echo 'textbox_un_edit';}else{ echo 'textbox'; }?> form-control m-input m-input--square" id="close_time[wednesday_0]" name="close_time[wednesday_0]" value="<?=$close_time->wednesday;?>" <?php if($closed->wednesday=='yes'){ echo 'disabled'; }?> /></div>
                            <div class="gray_selectbox form-group m-form__group">
                              <select class="form-control m-input custom-select" id="close_time_zonewednesday_0" name="close_time_zone[wednesday_0]" <?=$wed_attr?>>
                              <option value=" ">Select</option>
                        ...
                        <tr id="tr_bg_checkthursday_0">
                          <td>Thursday</td>
                          <td>
                            <div class="c1 <?php if($closed->thursday!='yes') { echo 'blue_bg'; }?>" id="div_open_time_zonethursday_0"><span class="span_at"></span></div>
                            <div class="form-group m-form__group"><input type="text" class="<?php if($closed->thursday=='yes') { echo 'textbox_un_edit';}else{ echo 'textbox'; }?> form-control m-input m-input--square" id="open_time[thursday_0]" name="open_time[thursday_0]" value="<?=$open_time->thursday;?>" <?php if($closed->thursday=='yes'){ echo 'disabled'; }?>></div>
                            <div class="gray_selectbox form-group m-form__group">
                              <?php
                              ...
                              ?>
                              <select class="form-control m-input custom-select" id="open_time_zonethursday_0" name="open_time_zone[thursday_0]" <?=$thu_attr?>>
                                <option value=" ">Select</option>
                          ...
                          <td>
                            <div class="form-group m-form__group"><input type="text" class="<?php if($closed->thursday=='yes') { echo 'textbox_un_edit';}else{ echo 'textbox'; }?> form-control m-input m-input--square" id="close_time[thursday_0]" name="close_time[thursday_0]" value="<?=$close_time->thursday;?>" <?php if($closed->thursday=='yes'){ echo 'disabled'; }?> ></div>
                            <div class="gray_selectbox form-group m-form__group">
                              <select class="form-control m-input custom-select" id="close_time_zonethursday_0" name="close_time_zone[thursday_0]" <?=$thu_attr?>>
                              <option value=" ">Select</option>
                        ...
                        <tr id="tr_bg_checkfriday_0">
                          ...
                          <td>
                            ...
                            <div class="gray_selectbox form-group m-form__group">
                             ...
                             ?>
                              <select class="form-control m-input custom-select" id="open_time_zonefriday_0" name="open_time_zone[friday_0]" <?=$fri_attr?>>
                                <option value=" ">Select</option>
                          ...
                          <td>
                            ...
                            <div class="form-group m-form__group"><input type="text" class="<?php if($closed->friday=='yes') { echo 'textbox_un_edit';}else{ echo 'textbox'; }?> form-control m-input m-input--square" id="close_time[friday_0]" name="close_time[friday_0]" value="<?=$close_time->friday;?>" <?php if($closed->friday=='yes'){ echo 'disabled'; } ?> ></div>
                            <div class="gray_selectbox form-group m-form__group">
                              <select class="form-control m-input custom-select" id="close_time_zonefriday_0" name="close_time_zone[friday_0]" <?=$fri_attr?>>
                              <option value=" ">Select</option>
                        ...
                        <tr id="tr_bg_checksaturday_0">
                          <td>Saturday</td>
                          <td>
                            <div id="div_open_time_zonesaturday_0"><span class="span_at"></span></div>
                            <div class="form-group m-form__group"><input type="text" class="<?php if($closed->saturday=='yes') { echo 'textbox_un_edit';}else{ echo 'textbox'; }?> form-control m-input m-input--square" id="open_time[saturday_0]" name="open_time[saturday_0]" value="<?=$open_time->saturday;?>" <?php if($closed->saturday=='yes'){ echo 'disabled'; } ?>></div>
                            <div class="gray_selectbox form-group m-form__group">
                              <?php
                              ...
                              <select class="form-control m-input custom-select" id="open_time_zonesaturday_0" name="open_time_zone[saturday_0]" <?=$sat_attr?>>
                                 <option value=" ">Select</option>
                          ...
                          <td>
                            <div class="form-group m-form__group">
                              <input type="text" class="<?php if($closed->saturday=='yes') { echo 'textbox_un_edit';}else{ echo 'textbox'; }?> form-control m-input m-input--square" id="close_time[saturday_0]" name="close_time[saturday_0]" value="<?=$close_time->saturday;?>" <?php if($closed->saturday=='yes'){ echo 'disabled'; } ?>>
                            </div>
                            <div class="gray_selectbox form-group m-form__group">
                              <select class="form-control m-input custom-select" id="close_time_zonesaturday_0" name="close_time_zone[saturday_0]" <?=$sat_attr?>>
                                <option value=" ">Select</option>
