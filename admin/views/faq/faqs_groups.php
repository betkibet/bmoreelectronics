      ...
      <div class="m-content">
		...
		<div class="m-alert m-alert--icon m-alert--air m-alert--square alert alert-dismissible m--margin-bottom-30" role="alert">
			...
			<div class="m-alert__text">
				...
				You can use this shortcode [faqs_groups] in pages for display group based faqs
            ...
            <div class="m-portlet__head-tools">
              ...
              <ul class="m-portlet__nav">
                ...
                <li class="m-portlet__nav-item">
                  ...
                  <a href="edit_faq_group.php" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">
            ...
            <div id="m_table_1_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
			  ...
			  <div class="row m--margin-top-20">
				...
				<div class="col-sm-12">
					...
					<form action="controllers/faq_group.php" method="POST">
						...
						if($num_rows>0) {
							...
							while($faq_data=mysqli_fetch_assoc($query)) { ?>
								...
								<tr>
								  ...
								  <td><?=get_faq_group_cats_nm($faq_data['cat_id'])?></td>
								  ...
								  <td Width="190">
									...
									if($faq_data['status']==1) {
										...
										echo '<a href="controllers/faq_group.php?p_id='.$faq_data['id'].'&status=0"><button class="btn btn-brand m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air btn-xs" style="pointer-events: none;">Published</button></a>';

									} elseif($faq_data['status']==0) {

										echo '<a href="controllers/faq_group.php?p_id='.$faq_data['id'].'&status=1"><button class="btn btn-danger m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air btn-xs" style="pointer-events: none;">Unpublished</button></a>';
									...
									<a href="edit_faq_group.php?id=<?=$faq_data['id']?>" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"><i class="la la-edit"></i></a>
									...
									if($prms_faq_delete == '1') {
										...
										if(isset($faq_data['type']) && $faq_data['type']!="fixed") { ?>
											...
											<a href="controllers/faq_group.php?d_id=<?=$faq_data['id']?>" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" onclick="return confirm('Are you sure to delete this record?')"><i class="la la-trash"></i></a>
