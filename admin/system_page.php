...
if(isset($_POST['search'])) {
	$_SESSION['system_page_filter_data'] = array('filter_by'=>$post['filter_by']);
	setRedirect(ADMIN_URL.'system_page.php');
}

if(isset($_GET['clear'])) {
	unset($_SESSION['system_page_filter_data']);
	setRedirect(ADMIN_URL.'system_page.php');
}

if(isset($_SESSION['system_page_filter_data'])) {
	$system_page_filter_data = $_SESSION['system_page_filter_data'];
	$post['filter_by'] = $system_page_filter_data['filter_by'];
}
