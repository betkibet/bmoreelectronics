...
if(! defined('DEFAULT_WIDTH') )				define ('DEFAULT_WIDTH', 200);							// Default thumbnail width. Allows overrid in timthumb-config.php

if(! defined('DEFAULT_HEIGHT') )			define ('DEFAULT_HEIGHT', 150);							// Default thumbnail height. Allows overrid in timthumb-config.php
...
class timthumb {
	...
	public function __construct(){
		...
		$this->src = $this->param('imglocation');
