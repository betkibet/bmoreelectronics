<?php
$brand_single_data = get_brand_single_data_by_sef_url($url_second_param);
$device_single_data = get_device_single_data($url_third_param);

//Get from index.php, get_device_single_data function
$device_single_data = $device_single_data['device_single_data'];
$device_id = $device_single_data['device_id'];

//Get from index.php, get_brand_single_data_by_sef_url function
$brand_single_data = $brand_single_data['brand_single_data'];
...
$model_data_list = get_brand_device_models_data_list($brand_id, $device_id);
...
//$main_title = "SELL YOUR ".$device_single_data['device_title'].' '.$main_title_last_word;
...
<div id="breadcrumb">
	<div class="wrap">
		<ul>
			...
			<li><a href="<?=SITE_URL.'brand/'.$brand_single_data['sef_url']?>">Select Your Device</a></li>
