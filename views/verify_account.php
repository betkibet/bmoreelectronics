				...
				<div class="form-signup">
				  ...
				  <div class="form-inline form-group-full clearfix">
					<div class="form-group">
					  ...
					  <div class="clearfix">
						<input type="number" class="form-control" name="verification_code" id="verification_code" placeholder="">
					  </div>
					</div>
				  </div>
				  <div class="form-inline form-group-full clearfix">
				  ...
				  <form class="pt-5" action="<?=SITE_URL?>controllers/user/verify_account.php" method="post">
					  <?php
