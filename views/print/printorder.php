  ...
  <section class="print">
    <div class="container">
      <div class="row hide_button">
        <div class="col-md-6">
          <input name="cancelButton" type="button" value="Back to My Account" id="cancelButton" class="btn btn-general" onClick="parent.location='<?=SITE_URL?>account<?=($_REQUEST['p']>0?'?p='.$_REQUEST['p']:'')?>'" />
        </div>
        <div class="col-md-6">
