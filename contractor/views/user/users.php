            ...
            <div id="m_table_1_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                  ...
                  <div id="m_table_1_filter" class="dataTables_filter float-left">
                    <form method="post">
                        <div class="input-group">
                          <input type="search" class="form-control m-input user_input_filter" placeholder="Name or Email or Phone" name="filter_by" id="filter_by" value="<?=_dt_parse($post['filter_by'])?>" autocomplete="nope">
              ...
              <div class="row">
                ...
                <form action="controllers/device.php" method="post">
                  <table class="table table-bordered table-hover table-checkable dataTable dtr-inline table-responsive">
                    <thead>
                      <tr>
                        <th width="10">
					...
					if($num_rows>0) {
						while($customer_data=mysqli_fetch_assoc($user_query)) {
							$order_reports_data = get_order_reports($customer_data['id'], $admin_l_id);
							...
							<tr>
								...
								if($prms_customer_delete == '1' && $customer_data['id'] == $admin_l_id) { ?>
