                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td Width="150">
							...
							if($prms_order_delete == '1') { ?>
							<a href="controllers/order/order.php?d_id=<?=$order_data['order_id']?>&order_mode=unpaid" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" onclick="return confirm('Are you sure you want to delete this record?')"><i class="la la-trash"></i></a>
							<?php
							} ?>
                          </td>
                        </tr>
