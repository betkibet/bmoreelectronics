              ...
              <div class="row">
                <div class="col-sm-12">
                  <div id="m_table_1_filter" class="dataTables_filter float-left">
                    <form method="post">
                        <div class="form-group row paid_order_section">
							<div class="col-lg-3">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td Width="150">
							...
							if($prms_order_delete == '1') { ?>
							<a href="controllers/order/order.php?d_id=<?=$order_data['order_id']?>&order_mode=paid" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" onclick="return confirm('Are you sure you want to delete this record?')"><i class="la la-trash"></i></a>
							<?php
							} ?>
                          </td>
                        </tr>
