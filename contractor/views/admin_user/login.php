...
<!-- begin:: Page -->
<div class="m-grid m-grid--hor m-grid--root m-page main_login_section">
        ...
        <div class="m-login__signin">
          ...
          <form class="m-login__form m-form" action="controllers/admin_user/login.php" method="post" role="form" onSubmit="return checklogin(this);">
            <div class="form-group m-form__group">
              <input class="form-control m-input" type="text" name="username" id="username" placeholder="Email" autocomplete="off" value="<?=$cookie_data['username']?>">
            </div>
            <div class="form-group m-form__group">
