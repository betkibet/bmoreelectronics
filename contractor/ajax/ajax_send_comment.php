...
if($comment=="" && $c_status=="") {
	...
	if($order_id!="" && $comment!="") {
		$c_query = mysqli_query($db,"INSERT INTO comments(`order_id`, `contractor_id`, `comment`, `order_status`, `thread_type`, `date`) VALUES('".$order_id."','".$contractor_id."','".$comment."','".$c_status."','contractor','".$date."')");
		if($c_query == '1') {
