...
<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
  ...
  <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
    <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
		...
		<li class="m-menu__item  m-menu__item--submenu <?php if($file_name=="awaiting_orders" || $file_name=="orders" || $file_name=="paid_orders" || $file_name=="archive_orders" || $file_name=="edit_order" || $file_name=="add_order"){echo 'm-menu__item--active m-menu__item--open';}?>" aria-haspopup="true"  m-menu-submenu-toggle="hover">
			...
			<div class="m-menu__submenu ">
			  ...
			  <ul class="m-menu__subnav">
				...
				<li class="m-menu__item <?php if($file_name=="awaiting_orders" || ($file_name=="edit_order" && $_GET['order_mode']=="awaiting") || ($file_name=="add_order" && $_GET['order_mode']=="awaiting")){echo 'm-menu__item--active';}?>" aria-haspopup="true" >
				...
				<li class="m-menu__item <?php if($file_name=="orders" || ($file_name=="edit_order" && $_GET['order_mode']=="unpaid") || ($file_name=="add_order" && $_GET['order_mode']=="unpaid")){echo 'm-menu__item--active';}?>" aria-haspopup="true" >
				...
				<li class="m-menu__item <?php if($file_name=="paid_orders" || ($file_name=="edit_order" && $_GET['order_mode']=="paid") || ($file_name=="add_order" && $_GET['order_mode']=="paid")){echo 'm-menu__item--active';}?>" aria-haspopup="true" >
				...
				<li class="m-menu__item <?php if($file_name=="archive_orders" || ($file_name=="edit_order" && $_GET['order_mode']=="archive") || ($file_name=="add_order" && $_GET['order_mode']=="archive")){echo 'm-menu__item--active';}?>" aria-haspopup="true" >
